...
float C74GenAudioProcessor::getParameter (int index)
{
    ...
    switch(index){
        case 0:
            gainValue = normalisedValue;
            gainLabelValue = String(round(value * 100) / 100) + " dB";
            break;
        case 1:
            distanceValue = normalisedValue;
            break;
        case 2:
            pathValue = normalisedValue;
            break;
        case 3:
            directionValue = normalisedValue;
            switch(int(value)){
                case 0: directionLabelValue = "RIGHT"; break;
                case 1: directionLabelValue = "LEFT"; break;
...
Value& C74GenAudioProcessor::getPathValueObject()
    {
        return pathValue;
    }

Value& C74GenAudioProcessor::getDistanceValueObject()
    {
        return distanceValue;
    }

Value& C74GenAudioProcessor::getDirectionValueObject()
    {
        return directionValue;
    }
Value& C74GenAudioProcessor::getDirectionLabelObject()
    {
        return directionLabelValue;
    }

Value& C74GenAudioProcessor::getGainValueObject()
    {
        return gainValue;
    }
Value& C74GenAudioProcessor::getGainLabelObject()
    {
        return gainLabelValue;
    }
