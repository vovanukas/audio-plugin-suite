...
public:
    ...
    Value& getPathValueObject();
    
    Value& getDistanceValueObject();
    
    Value& getDirectionValueObject();
    Value& getDirectionLabelObject();
    
    Value& getGainValueObject();
    Value& getGainLabelObject();
...
private:
    ...
    Value directionLabelValue;
    
    Value gainValue;
    Value gainLabelValue;
    //==============================================================================
