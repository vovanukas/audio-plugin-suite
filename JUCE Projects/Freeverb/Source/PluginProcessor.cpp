...
float C74GenAudioProcessor::getParameter (int index)
{
    ...
    t_param normalisedValue = (value - min) / range;
	
	value = (value - min) / range;
	
    switch(index){
        case 0:
            dampValue = normalisedValue;
            dampLabelValue = String(value);
            break;
        case 1:
            fb1Value = normalisedValue;
            fb1LabelValue = String(round(value * 100) / 100);
            break;
        case 2:
            fb2Value = normalisedValue;
            fb2LabelValue = String(round(value * 100) / 100);
            break;
        case 3:
            mixValue = normalisedValue;
            mixLabelValue = String(int(value * 100)) + " %";
            break;
        case 4:
            spreadValue = normalisedValue;
            spreadLabelValue = String(value);
            break;
...
Value& C74GenAudioProcessor::getFb1ValueObject()
    {
        return fb1Value;
    }
Value& C74GenAudioProcessor::getFb1LabelObject()
    {
        return fb1LabelValue;
    }

Value& C74GenAudioProcessor::getFb2ValueObject()
    {
        return fb2Value;
    }
Value& C74GenAudioProcessor::getFb2LabelObject()
    {
        return fb2LabelValue;
    }

Value& C74GenAudioProcessor::getDampValueObject()
    {
        return dampValue;
    }
Value& C74GenAudioProcessor::getDampLabelObject()
    {
        return dampLabelValue;
    }

Value& C74GenAudioProcessor::getSpreadValueObject()
    {
        return spreadValue;
    }
Value& C74GenAudioProcessor::getSpreadLabelObject()
    {
        return spreadLabelValue;
    }

Value& C74GenAudioProcessor::getMixValueObject()
    {
        return mixValue;
    }
Value& C74GenAudioProcessor::getMixLabelObject()
    {
        return mixLabelValue;
    }

void C74GenAudioProcessor::valueChanged (Value& v)
    {
        updateHostDisplay();
    }
