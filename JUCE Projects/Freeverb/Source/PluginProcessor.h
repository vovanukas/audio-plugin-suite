...
public:
    ...
    Value& getFb1ValueObject();
    Value& getFb1LabelObject();
    
    Value& getFb2ValueObject();
    Value& getFb2LabelObject();
    
    Value& getDampValueObject();
    Value& getDampLabelObject();
    
    Value& getSpreadValueObject();
    Value& getSpreadLabelObject();
    
    Value& getMixValueObject();
    Value& getMixLabelObject();
...
private:
    ...
    Value dampValue;
    Value dampLabelValue;
    
    Value spreadValue;
    Value spreadLabelValue;
